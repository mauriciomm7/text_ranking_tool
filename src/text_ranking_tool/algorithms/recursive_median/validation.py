# src/text_ranking_tool/algorithms/recursive_median/validation.py

from typing import List, Dict, Any
from .schema import REQUIRED_COLUMNS

def validate_input_data(data: List[Dict[str, Any]]) -> Dict[str, Any]:
    """Validate input data for recursive median algorithm"""
    ...
    # Recursive median needs at least 2 texts for partitioning
    if len(data) < 2:
        return {"valid": False, "error": "Recursive median needs at least 2 texts"}
